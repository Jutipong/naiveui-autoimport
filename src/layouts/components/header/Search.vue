...
<template>
    <CommonWrapper @click="openModal">
        <icon-park-outline-search /><n-tag round size="small" class="cursor-pointer font-mono">
            CtrlK
        </n-tag>
    </CommonWrapper>
    <n-modal
        v-model:show="showModal"
        class="fixed inset-x-0 top-60px w-560px"
        size="small"
        preset="card"
        :segmented="{
            content: true,
